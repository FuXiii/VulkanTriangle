...
int main()
{
    ...
    auto vulkan_code = [&]() {
        ...
        auto previous_point = std::chrono::steady_clock::now();
        float game_time = 0;
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            float scale = (std::sin(game_time * 0.5) + 1) * 0.5; //[0, 1]
            ...
            driver.vkCmdPushConstants(vk_command_buffer, vk_pipeline_layout, VkShaderStageFlagBits::VK_SHADER_STAGE_VERTEX_BIT, 0, sizeof(float), &scale);
