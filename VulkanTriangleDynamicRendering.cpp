#include <VulkanTriangleDynamicRendering.h>

#include <stdio.h>
#include <string.h>

void DynamicRenderingCore()
{
    ...
    {
        {
            ...
            // Vulkan 1.1
            // vkGetPhysicalDeviceFeatures2(targetPhysicalDevice, &features2);
            ...
            VkPhysicalDeviceVulkan13Features enable_vulkan_13_features = {};
            enable_vulkan_13_features.dynamicRendering = vulkan_13_features.dynamicRendering;

            VkDeviceCreateInfo device_create_info = {};
            device_create_info.pNext = &enable_vulkan_13_features;
        }

        {
            ...
            VkPhysicalDeviceDynamicRenderingFeatures enable_dynamic_rendering_features = {};
            enable_dynamic_rendering_features.dynamicRendering = dynamic_rendering_features.dynamicRendering;

            VkDeviceCreateInfo device_create_info = {};
            device_create_info.pNext = &enable_dynamic_rendering_features;
        }
    }
    ...
    // Pipeline Rendering
    {
        ...
        // If VkPipelineRenderingCreateInfo is included in the pNext chain, then renderPass must be VK_NULL_HANDLE
...
VulkanTriangle::VulkanTriangle()
{
    ...
    for (VkPhysicalDevice physcail_devices_item : physcail_devices)
    {
        ...
        {
            auto instance_version_major = VK_API_VERSION_MAJOR(this->apiVersion);
            auto instance_version_minor = VK_API_VERSION_MINOR(this->apiVersion);
            auto instance_version_patch = VK_API_VERSION_PATCH(this->apiVersion);

            auto physical_device_version_major = VK_API_VERSION_MAJOR(vk_physical_device_properties.apiVersion);
            auto physical_device_version_minor = VK_API_VERSION_MINOR(vk_physical_device_properties.apiVersion);
            auto physical_device_version_patch = VK_API_VERSION_PATCH(vk_physical_device_properties.apiVersion);
...
void VulkanTriangle::ResizeSurface(uint32_t width, uint32_t height)
{
    ...
    if (vk_swapchain_create_info_khr.oldSwapchain != VK_NULL_HANDLE)
    {
